        ...
        <div class="d-flex justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <img src="images/set.png" class="rounded-circle" alt="profile of client" width="40" height="40" srcset="">
                </a>
...
<div class="body mx-0"  style="min-height:83vh;">
    <div class="row mx-0 mt-1">
        ...
        <div class="mt-0 bg-dark" style="background-image:url(images/set.png);min-height:20vh;">
                <div class="profile">
                    <div class="py-3">&nbsp;</div>
                    <strong class="text-white"style="position:absolute">
                    <img src="images/set.png" class="rounded-circle mx-3" alt="profile image" width="100" height="100" srcset="">
                    MUGISHA Irene</strong>
            ...
            <div class="headline mt-3 position-relative border-primary border-top border-1">
                ...
                <p><b> Developer | NASSA Web Ltd</b></p>
            </div>
